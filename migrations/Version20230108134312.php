...
final class Version20230108134312 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE request (id INT AUTO_INCREMENT NOT NULL, id_manager_id INT NOT NULL, id_product_id INT NOT NULL, id_buyer_id INT DEFAULT NULL, INDEX IDX_3B978F9FDDB4B4B4 (id_manager_id), INDEX UNIQ_3B978F9FE00EE68D (id_product_id), INDEX UNIQ_3B978F9F3CAEBBB7 (id_buyer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
